...
public class AuthFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        if (null == hsr) {
            ...
            return this.routingFailed(rc, null);
        }
        ...
        if (null == response
            ...
            log.error("[request-noLogin] = {}", request);
            return this.routingFailed(rc, "No login");
        }
     ...
     * @return
     */
    private Object routingFailed(RequestContext rc, String msg) {
        ...
        rc.setResponseBody(StringUtils.defaultString(msg, pageNoPermissionMsg));
        log.warn("[request-routingFailed] msg = {}", msg);
        return null;
    }
}
